            <div class="card-header">
                ...
                <div class="card-tools float-right d-inline-flex"><span class="mt-1 mr-2">全<span class="count">{{$row_count}}</span>件</span>{{$housings->links()}}</div>
                </div>
                <div class="card-body">
                @if(count($housings)>0)
        ...
        <td class="col-sm-4">
            <div class="float-sm-right">
                <a href="/housing/{{$housing->id}}" class="mr-2">
                ...
                <button  class="btn btn-danger btn-sm deleteHousing" id="deletehousing" data-id="{{$housing->id}}">
...
@endforeach
            ...
            <div class="card-footer">
                <div class="card-tools float-right d-inline-flex"><span class="m-2">全<span class="count">{{$row_count}}</span>件</span>{{$housings->links()}}</div>
            </div>

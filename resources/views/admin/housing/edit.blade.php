    ...
    <div class="container-fluid">
      ...
      <div class="mt-4 mb-2" id="url_string">
        <span class="mr-2 font-weight-bold h6">リンク:
          <span id="created_url">{{url("/house/")."/".$housing->id}}</span>
        </span>
        <a href='{{url("/house/")."/".$housing->id}}'id="link_url" class="btn btn-sm btn-default" target="_blank">表示</a>
      </div>
    </div><!-- /.container-fluid -->
  </div>
  <!-- /.content-header -->
              ...
              <div class="card-body">
                  <div class="form-group row">
                      ...
                      <div class="ml-1 custom-file col-sm-7">
                          <input type="file" class="custom-file-input" accept="video/*" id="video_file" name="video_file" value = "{{$housing->video_url}}">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="ml-1 dropzone-wrapper col-sm-7" id="dropzon_wrap">
                          ...
                          <input type="file" name="ow_images[]" accept="image/*" id="ow_dropzone" class="dropzone" multiple="multiple">
                      </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="ml-1 dropzone-wrapper col-sm-7" id="gallery_dropzone_wrap">
                          ...
                          <input type="file" name="gallery_images[]" accept="image/*" class="dropzone" id="gallery_dropzone" multiple>
                      </div>
                  </div>
                  <div class="form-group row">
                      <label class="col-sm-4 col-form-label">動画（Ownerʼs Voice）</label>
                      <div class="ml-1 custom-file col-sm-7">
                          <input type="file" class="custom-file-input" accept="video/*" id="voice_file" name="voice_file">

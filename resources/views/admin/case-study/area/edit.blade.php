      ...
      <div class="mb-2 row">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="{{ url('/admin/case-study-area/create') }}">地域</a></li>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="card">
            ...
            <div class="card-body">
              <div>
                <button id="delete_area" class="btn btn-sm btn-danger" style="background-color:white;color:red;border:none"><strong>削除する</strong></button>

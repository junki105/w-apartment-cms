...
class ResultController extends Controller
{
  ...
  public function create()
  {
    ...
    return view('admin.case-study.create',compact('areas','housetypes','amounts'));
  ...
  public function edit($id)
  {
    ...
    $areas = Area::all();
    $housetypes = HouseType::all();
    return view('admin.case-study.edit',compact('result','amounts','areas','housetypes'));
  }
  ...
  public function search(Request $request) {
    ...
    return view('admin.case-study.pagination_data',compact('results','count'));
